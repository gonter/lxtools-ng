/****************************************************************************  
  ...
  was: #Id: ftw.c,v 1.10 2000/07/01 18:36:28 wuftpd Exp #
...
#ifdef __NetBSD__
#define has_getcwd    /* replacement for getwd, defined in <unistd.h> */
#endif
...
#else
char *getwd(char *);
#define GETCWD(buff,size) getwd((buff))
#endif
